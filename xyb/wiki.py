...
def _community_article(
    ...
    lines += ["---", "", "*Part of the xiaoyibao knowledge wiki. See [[index]] to navigate.*"]
    return "\n".join(lines)
...
def _index_md(
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated by xiaoyibao. Start here — read community articles for context, then drill into god nodes for detail.",
        "",
    ...
    lines += [
        "---",
        "",
        "*Generated by [xiaoyibao](https://github.com/safishamsi/xiaoyibao)*",
    ]
    return "\n".join(lines)
