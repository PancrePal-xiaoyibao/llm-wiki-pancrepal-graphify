...
# ── Medical domain grouping ───────────────────────────────────────────────────

def group_by_type(G: nx.Graph) -> dict[str, list[str]]:
    """Group nodes by node_type attribute."""
...
def group_by_timeline(G: nx.Graph) -> dict[str, list[str]]:
    """Group TimelineEvent nodes by date prefix (YYYY-MM)."""
    groups: dict[str, list[str]] = {}
    for node_id, data in G.nodes(data=True):
